...
process.env.base = "http://localhost:1337";
process.env.callback = "http://localhost:3000/onboarding/welcome";
process.env.monzo_client = "oauthclient_00009ICD4jZ4oiGoSAvepl";
